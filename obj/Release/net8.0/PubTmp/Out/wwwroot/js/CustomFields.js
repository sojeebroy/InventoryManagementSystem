...
function initCustomFields(inventoryId) {
                    ...
                    <div class="col">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div>
                                ...
                                <small class="text-muted">${fieldType}${description ? ' â€¢ ' + escapeHtml(description) : ''}</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-auto">
    ...
    function updateFieldInUI(fieldId, title, fieldType, description, isVisible) {
        ...
        if (smallEl) smallEl.textContent = `${fieldType}${description ? ' â€¢ ' + description : ''}`;
        if (badge) {
    ...
    fieldsContainer.addEventListener('click', (e) => {
        ...
        if (editBtn) {
            ...
            const description = typeText.split('â€¢')[1]?.trim() || '';
            let type = '';
